...
public class PositionCalculatorTest {
    ...
    public void testCalculateLocation() {
        ...
        calc.down(now);
        assertThat("After 500ms of moving down at a rate of 1pr 100ms, position should be 55",
                calc.calculatedLocation(now.plusMillis(505)), is(equalTo(55)));

        calc.stop(now.plusMillis(800));
        assertThat("Stopped after 800ms, the position should be 58, even a long time after",
                calc.calculatedLocation(now.plusMillis(3000)), is(equalTo(58)));
    }
