...
public class HouseMqttContext {
  ...
  public static MqttOptions loadDefaultOptions(String adapterName) {
    MqttConfiguration config =
        new ConfigurationLoader(configFile(ENV_CONFIG_MQTT, "mqtt-client.yaml").toString())
  ...
  private static Path configFile(String configFileEnv, String defaultFilename) {
    Path filePath =
        Paths.get(Objects.requireNonNullElse(System.getenv(configFileEnv), defaultFilename));
