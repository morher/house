...
public class RoomSensorDevice {
    ...
    /**
     * A{@link BinarySensorEntity} definition for devices reporting room opening states, such as doors and windows.
     * 
     * <p>
     * When the door/window is open, the binary sensor reports ON.
     */
    public static final EntityDefinition<BinarySensorEntity> OPENING = new EntityDefinition<>("Opening", (em, id) -> em.binarySensorEntity(id));
}
