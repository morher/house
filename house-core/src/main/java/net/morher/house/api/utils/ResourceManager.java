...
/**
 * <p>
 * The ResourceManager helps manage {@link AutoCloseable} resources by registering them and providing a single {@link #close()}
 * method to close all of them.
 * 
 * <p>
 * When resources are created in a constructor the {@link ConstructionBlock} from {@link #constructionBlock()} can help close
 * resources created in case of a failure.
 * 
...
public class ResourceManager implements AutoCloseable {
    ...
    /**
     * Try to close all the registered resources. If any of the resources throws an exception during close, the first Exception
     * will be rethrown when all resources are closed.
     */
    @Override
     ...
     * <lI>Then at the end of the try-block mark the ConstructionBlock as {@link ConstructionBlock#complete() complete}.
     * 
     * <p>
     * If {@link ConstructionBlock#complete()} is not called before the try-with-resources block ends,
     * {@link ResourceManager#closeQuietly()} is called, and all the registered resources will be closed.
     * 
     * @author Morten Hermansen
     */
