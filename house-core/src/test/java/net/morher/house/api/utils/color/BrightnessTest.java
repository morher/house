...
public class BrightnessTest {
    ...
    public void testOfNullable() {
        ...
        assertThat(Brightness.ofNullable(50, 0, 100), OptionalMatchers.isPresentAndIs(new Brightness(0.5)));

        assertThat(Brightness.ofNullable((Double) null, 0.0, 100.0), isEmpty());
        assertThat(Brightness.ofNullable(50.0, 0.0, 100.0), OptionalMatchers.isPresentAndIs(new Brightness(0.5)));
    }
