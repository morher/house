...
public class ColorTest {
    ...
    public void testSerialize() throws JsonProcessingException {
        assertThat(new ObjectMapper().writeValueAsString(Color.fromHex("#FFFFFF")), is(equalTo("\"#ffffff\"")));
        assertThat(new ObjectMapper().writeValueAsString(Color.fromHex("#FFF")), is(equalTo("\"#ffffff\"")));
    }
