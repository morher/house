...
public class HouseSchedulerLocator {
  private static String SCHEDULER_TEST_IMPLEMENTATION =
      "net.morher.house.test.schedule.TestHouseScheduler";
  private static String SCHEDULER_IMPLEMENTATION =
      "net.morher.house.api.schedule.DefaultHouseScheduler";
  ...
  private static HouseScheduler loadImplementation(String implementationClass) {
    try {
      ...
      throw new IllegalStateException(
          "Cannot instantiate the HouseScheduler implementation " + implementationClass, e);
    }
  }
}
