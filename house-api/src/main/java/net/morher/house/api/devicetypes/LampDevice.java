...
/**
 * Common {@link EntityDfinition entity definitions} for lamps. The most common entity is probably {@link #LIGHT light}.
 * 
...
public abstract class LampDevice {
     ...
     */
    public static final EntityDefinition<LightEntity> LIGHT = new EntityDefinition<>("Light", (em, id) -> em.lightEntity(id));
}
