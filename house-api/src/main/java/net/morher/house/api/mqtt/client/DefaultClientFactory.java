...
public class DefaultClientFactory implements MqttClientFactory {
    ...
    @Override
    public IMqttAsyncClient connect(MqttOptions options, MqttAvailabilityPolicy availability, MqttCallback mqttCallback) throws MqttException {
    ...
    protected MqttConnectOptions createConnectOptions(MqttOptions options, MqttAvailabilityPolicy availability) {
    ...
    protected void connect(IMqttAsyncClient client, MqttCallback mqttCallback, MqttConnectOptions connectOptions) throws MqttException {
        client.setCallback(mqttCallback);
        client.connect(connectOptions)
                .waitForCompletion();
    }

    protected void publishAvailable(IMqttAsyncClient client, MqttAvailabilityPolicy availability) throws MqttException {
        if (availability != null) {
            client
                    .publish(
                            availability.getTopic(),
