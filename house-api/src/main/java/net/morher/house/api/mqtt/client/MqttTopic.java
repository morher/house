...
public class MqttTopic<T> implements Topic<T> {
    ...
    public MqttTopic(HouseMqttClient mqtt, String topic, PayloadFormat<T> serializer, boolean retainByDefault) {
        this.mqtt = mqtt;
        this.topic = topic;
    ...
    @Override
    public <S> Topic<S> subTopic(String postFix, PayloadFormat<S> serializer, boolean retainByDefault) {
