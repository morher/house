...
public class CoverEntity extends CommandableEntity<CoverState, CoverOptions, CoverCommand> {
    ...
    public static class StateCommandPair {
        private final MqttTopicManager<Integer> state;
        private final MqttTopicManager<Integer> command;

        public MqttTopicManager<Integer> state() {
            return state;
        }

        public MqttTopicManager<Integer> command() {
            return command;
        }
    }
}
